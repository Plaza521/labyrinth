...
def append_zeros(number, outlen=5):
...
def main():
	...
	for path in maplist:
		...
		""")
		conn.commit()
		maps_map = (append_zeros(mapid), append_zeros(startpos[0]), append_zeros(startpos[0]), list_to_string(outmap))
		cur.execute("""INSERT INTO maps(mapid, startx, starty, mapinfo) 
		   VALUES({}, {}, {}, {});""".format('00003', append_zeros(startpos[0]), append_zeros(startpos[0]), list_to_string(outmap)))
		conn.commit()
		mapid+=1
